...
# Barplot, Pie Chart, Line Chart, Scatter plot, Histogram and Treemap
...
# Ggplot2 
library(ggplot2)
View(mtcars) #Visualizar dataset do pacote do R
...
title(main = "Produ��o de Veiculos", col.main = "red", font.main = 4)
